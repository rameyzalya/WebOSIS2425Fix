      ...
      <div className="container">
        <div className="flex flex-wrap">
          <div className="w-full px-4 mb-12 text-slate-200 font-medium md:w-1/3">
            ...
            <p>
              Jl. A. P. Pettarani No.4, Gn. Sari, Kec. Rappocini,
              <br />
              Kota Makassar.
            </p>
          ...
          <div className="w-full px-4 mb-12 md:w-1/3">
            ...
            <div className="flex space-x-4">
              {/* Instagram */}
              <Link
                href="https://www.instagram.com/osisstelkmks?igsh=MXNpcmxtdXp5N3NmaA=="
                target="_blank"
              ...
              {/* TikTok */}
              <Link
                href="https://www.tiktok.com/@osisstelkmks?_t=ZS-8xX9PS036FV&_r=1"
                target="_blank"
                rel="noopener noreferrer"
              >
