        ...
        <div className="flex flex-wrap items-center relative lg:flex-row-reverse">
          ...
          <div className="w-full p-2 lg:w-1/2 mb-[250px] pt-[150px]">
            ...
            <p className="text-[20px] text-gray-700 mt-4 text-justify">
              ...
              bermanfaat serta memberi pengalaman berharga. SMK Telkom Makassar
              bukan hanya tempat belajar, tetapi juga rumah bagi potensi,
              kreativitas, dan cita-cita besar. Mari kita bersama menciptakan
              lingkungan yang positif dan inspiratif untuk mencapai visi
              bersama. Terima kasih atas kepercayaan dan dukungannya. Semoga
              kebersamaan ini terus membawa kita ke arah yang lebih baik.&quot;
            </p>
