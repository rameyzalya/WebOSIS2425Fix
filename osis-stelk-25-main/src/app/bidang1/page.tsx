...
import ig2 from "../_assets/ig2.png"; // Import images directly from their paths
import farras from "../_assets/anggota/bidang 1/farras.png";
import auf from "../_assets/anggota/bidang 1/auf.png";
import pascal from "../_assets/anggota/bidang 1/pascal.png";
import orville from "../_assets/anggota/bidang 1/orpil.png";
import fhadlan from "../_assets/anggota/bidang 1/fadlan.png";
import kaysia from "../_assets/anggota/bidang 1/kaysa.png";
    ...
    <>
      <div className="judul mt-[150px] w-max text-center flex-col items-center mx-auto mb-20">
        ...
        <p className="text-[20px] font-semibold text-[#6B0000]">
          KEIMANAN KEPADA TUHAN YANG MAHA ESA DAN AKHLAK MULIA
        </p>
      </div>
      ...
      <div className="h-[120vh] bg-[#6B0000] mt-[70px] text-center flex flex-col items-center ">
        <div className="judul display flex flex-col items-center w-[800px] text-center">
          ...
          <p className="text-white text-xl m-3">
            Mengarahkan siswa untuk memperkuat keimanan dan memiliki akhlak yang
            baik melalui berbagai kegiatan keagamaan dan pembinaan moral,
            seperti kajian agama, kegiatan rohani, dan program yang mendorong
            perilaku positif.
          </p>
        </div>
        <div className="flex mt-5 w-[800]">
          ...
          <div className="ketubing m-auto pl-10 text-left">
            ...
            <div className="flex flex-col items-start">
              <h2 className="text-[3rem] text-white pb-2 max-lg:text-[2rem]">
                SYAUQI NUR FAUZI
              </h2>
              <div className="h-1 w-[50%] bg-white item-star"></div>
            </div>
            <Link
              href="https://www.instagram.com/syauqinf?igsh=YTNxbXprZ2JyZHUw"
              target="_blank"
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <Link
                    href="https://www.instagram.com/muhammad_isra_farras?igsh=YXoycTV3b3c5bGt3"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/nisaauufa?igsh=ZjRzMDJrYW9oamxr"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/mi.pasc?igsh=MXYxOW9xMmQ0djRpMg=="
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/heyy.orville/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/oy_padlan?igsh=dzNsZjNtOGpscGd2"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
