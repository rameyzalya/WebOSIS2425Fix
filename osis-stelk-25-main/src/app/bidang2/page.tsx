...
import brayn from "../_assets/anggota/bidang 2/brayn.png";
import jacqlein from "../_assets/anggota/bidang 2/jacqlein.png";
import mia from "../_assets/anggota/bidang 2/mia.png";
import nade from "../_assets/anggota/bidang 2/nade.png";
import nahza from "../_assets/anggota/bidang 2/nahza.png";
import richard from "../_assets/anggota/bidang 2/richard.png";
import yudhi from "../_assets/anggota/bidang 2/yudhi.png";
    ...
    <>
      ...
      <div className="relative items-center h-max-w-[100vw] mx-auto mt-0 flex flex-col justify-center text-center">
        ...
        <Image
          ...
          height={1500}
          alt="foto"
          className="max-w-full relative z-0 mt-1 md:bottom-[-75px]"
        />
        {/* Yu Image */}
        <Image
          src={yu}
      ...
      <div className="h-[120vh] bg-[#6B0000] mt-[70px] text-center flex flex-col items-center ">
        <div className="judul display flex flex-col items-center w-[800px] text-center">
          ...
          <p className="text-white text-xl m-3">
            Berfokus pada pembentukan karakter kebangsaan, penanaman nilai
            to,leransi, dan kepekaan sosial yang luas, menjadikannya dasar yang
            kuat untuk membangun siswa yang cinta tanah air, peduli lingkungan,
            dan toleran.
          </p>
        </div>
          ...
          <div className="ketubing m-auto pl-20 text-left">
            ...
            <div className="flex flex-col items-start">
              <h2 className="text-[3rem] text-white pb-2 max-w-[500px] max-lg:text-[2rem]">
                ANDI MAKKAWARU NABIL AL-FATAH
              </h2>
              <div className="h-1 w-[50%] bg-white item-star"></div>
            </div>
            <Link
              href="https://www.instagram.com/nabilalftah?igsh=Nmp5MXl0d2U5Ymhz"
              target="_blank"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-[40px]">
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <Link
                    href="https://www.instagram.com/brrynnn_21?igsh=MXdjdTQwYnM3MjBwaQ=="
                    target="_blank"
                    rel="noopener noreferrer"
                  >
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  <h2 className="text-[25px] font-bold pb-2 text-[#6B0000] mt-5">
                    JACQLIEN ECCLESIA GERALDY PEURU
                  </h2>
                  <h2 className="text-[18px] font-bold pb-2 text-[#6B0000]">
                    Anggota
                  </h2>
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/jacqlienecclessia?igsh=ZHgzMm9mMGRmY2hi"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/m14thlita?igsh=M2drZmNmMzFkaHRi"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/anadya.ar?igsh=b3RjcGc0bXNkdGNk&utm_source=qr"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/_nzzzmsrh?igsh=ZG1lMXZhdjV4eXg3"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/jp_richard___?igsh=anZiYTFjMmlzbTNj"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/ykins_?igsh=MTVtdW1wYXlrN3BtYw=="
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
