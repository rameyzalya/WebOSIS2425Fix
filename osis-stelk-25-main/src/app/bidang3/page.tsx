...
import agnes from "../_assets/anggota/bidang 3/agnes.png";
import anya from "../_assets/anggota/bidang 3/anya.png";
import fadhil from "../_assets/anggota/bidang 3/fadhil.png";
import fiqih from "../_assets/anggota/bidang 3/fiqih.png";
import raisya from "../_assets/anggota/bidang 3/raisya.png";
import reza from "../_assets/anggota/bidang 3/reza.png";
import zize from "../_assets/anggota/bidang 3/zize.png";
    ...
    <>
      ...
      <div className="relative items-center h-max-w-[100vw] mx-auto mt-10 flex flex-col justify-center text-center">
        ...
        <Image
          ...
          height={1500}
          alt="foto"
          className="max-w-full relative z-0 mt-1 md:bottom-[-70px]"
        />
        {/* Yu Image */}
        <Image
          src={yu}
      ...
      <div className="h-[120vh] bg-[#6B0000] mt-[70px] text-center flex flex-col items-center ">
        <div className="judul display flex flex-col items-center w-[800px] text-center">
          ...
          <p className="text-white text-xl m-3">
            Sebagai ruang bagi siswa untuk mengeksplorasi minat dan bakat serta
            mencapai prestasi di bidang akademik, seni, budaya, dan olahraga
            melalui kompetisi, turnamen, dan festival yang terstruktur.
          </p>
        </div>
          ...
          <div className="ketubing m-auto pl-20 text-left">
            ...
            <div className="flex flex-col items-start">
              <h2 className="text-[3rem] text-white pb-2 max-w-[500px] max-lg:text-[2rem]">
                MUHAMMAD NABIL SAFWAN
              </h2>
              <div className="h-1 w-[50%] bg-white item-star"></div>
            </div>
            <Link
              href="https://www.instagram.com/nabilsfwan?igsh=MXJ6eDdyZHZzYWdkYQ=="
              target="_blank"
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <Link
                    href="https://www.instagram.com/agnesia_maku?igsh=MTFhYmw5ZW9jNmFjMg=="
                    target="_blank"
                    rel="noopener noreferrer"
                  >
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/farsyacntika?igsh=ZzE0cmU4ZGVjam9m&utm_source=qr"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/al.hadyyy?igsh=MWNqMzY2bG10cW0wYg=="
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/firss_aja?igsh=bGJ5eXZjb2JtcW9h&utm_source=qr"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/onyoursyaaa?igsh=Yzl0YmRkOHhrYzc1"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/andisyahputra9872?igsh=MTFtcmNhbDYxcGkwag=="
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/___nrazizhh?igsh=MTFkNDhoZmk0YWZucQ=="
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
