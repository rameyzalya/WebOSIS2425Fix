      ...
      <div className="h-[120vh] bg-[#6B0000] mt-[70px] text-center flex flex-col items-center ">
        <div className="judul display flex flex-col items-center w-[800px] text-center">
          ...
          <p className="text-white text-xl m-3">
            Mengelola media sosial OSIS, mendokumentasikan kegiatan, serta
            membuat konten digital yang menarik. Bidang ini juga menyediakan
            pelatihan dasar teknologi dan komunikasi dalam bahasa lnggris,
            membantu siswa menjadi lebih siap dan kompetitif di era globalisasi.{" "}
          </p>
        </div>
        <div className="flex mt-20 w-[500]">
          ...
          <div className="ketubing m-auto pl-20 text-left">
            ...
            <Link
              href="https://www.instagram.com/1melvya?igsh=MTIxbjdxNGp4ODFoeQ%3D%3D&utm_source=qr"
              target="_blank"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-[40px]">
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://instagram.com/aylqao"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://instagram.com/aliefsyahlefi"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  ...
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://instagram.com/page.aldian"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
            ...
            <div className="max-w-[400px]">
              ...
              <div>
                <div className="flex flex-col items-start ml-5">
                  <h2 className="text-[25px] font-bold pb-2 text-[#6B0000] mt-5">
                    Muhammad Danish Zafran Atayallah{" "}
                  </h2>
                  <h2 className="text-[18px] font-bold pb-2 text-[#6B0000]">
                    Anggota
                  </h2>
                  <div className="h-1 w-[50%] bg-[#6B0000] item-star"></div>
                  <Link
                    href="https://www.instagram.com/dandyshs?igsh=MWZsaTZva3luemthMg=="
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Image src={ig2} alt="ig" className="mt-3" />
